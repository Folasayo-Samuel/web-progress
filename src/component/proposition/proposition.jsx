          ...
          <div className="col-sm-12 col-md-4  text-left">
            <ul className="listone">
              <li className="pb-5">
                ...
                <span className="text">Affordable digital insurance products</span>
              </li>
              <li className="pb-5">
                <span className="iconBox">
                ...
                <span className="text"> Seamless purchase of insurance products</span>
              </li>
              <li className="pb-5">
                <span className="iconBox">
                ...
                <span className="text"> Adequate cover with reliable insurance partners</span>
              </li>
              <li className="pb-5">
                <span className="iconBox">
